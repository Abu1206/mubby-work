...
function App() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      >
        <nav className="flex mx-auto flex-1 w-auto md:w-[1000px] align-middle justify-between p-5">
          ...
          <li className=" justify-between align-middle p-5 w-full ml-[50px] hidden md:flex ">
            <ul>about us</ul>
            <ul>services</ul>
            <ul>contact us</ul>
            <ul>
              <button className="p-2 bg-slate-400 text-black">
                get your quotation
              </button>
            </ul>
          </li>
      ...
      <section className="w-full h-[500px] bg-black text-white text-center p-5">
        <div className="space-y-3 mt-[150px]">
          <h3 className="font-bold text-2xl ">
        ...
        <img
          src={r1}
          alt="side"
          className="hidden md:block md:relative md:top-[-55%] md:right-[-1%] md:z-10 md:w-[200px] md:rotate-[-20deg]"
        />
        <img
          src={r2}
          alt="side"
          className="hidden md:block md:relative md:top-[-90%] md:left-[80%] md:z-10 md:w-[200px] md:rotate-[20deg]"
        />
        <img
          src={r3}
          alt="side"
          className="hidden md:block md:relative md:top-[-70%] md:left-[5%] md:z-10 w-[200px] md:rotate-[10deg]"
        />

        <img
          src={r4}
          alt="side"
          className="hidden md:block md:relative md:top-[-100%] md:left-[78%] md:z-10 w-[200px] md:rotate-[-15deg]"
        />
